...
const Header = () => {
  ...
  return (
    <div className="bg-[#F0F4F8] w-full min-h-[100vh]  flex items-center max-h-screen py-16 bg-[url('https://i.ibb.co/RYpZ68h/Group-5-3.png')] bg-no-repeat bg-right-top">
      <div className="max-w-[1440px] w-full mx-auto p-4  flex flex-between items-center ">
        {/* Content */}

        {/* Text */}
        <div className="w-full">
          <p className="text-xl mb-2 px-2 bg-gray-100 max-w-max rounded-md text-blue-700 font-bold">
            AxomSoft
          </p>
          <h1 className="text-5xl text-h-title font-extrabold text-[#0c7cc6]">
          ...
          <div className="flex gap-6 mt-2">
            ...
            <button onClick={() => setVisible(true)} className="bg-[#89cefb]  text-[blue-900] hover:shadow-lg duration-300 text-[18px] flex items-center gap-2 px-4 py-2 rounded-md">
